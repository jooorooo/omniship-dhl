...
/**
 * Class representing GetQuoteResponseAType
 */
class GetQuoteResponseAType
{

    /**
     * @property \Dhl\DCTResponse\GetQuoteResponseAType\ResponseAType $response
     */
     ...
     * Gets as response
     *
     * @return \Dhl\DCTResponse\GetQuoteResponseAType\ResponseAType
     */
     ...
     * Sets a new response
     *
     * @param \Dhl\DCTResponse\GetQuoteResponseAType\ResponseAType $response
     * @return self
     */
    public function setResponse(\Dhl\DCTResponse\GetQuoteResponseAType\ResponseAType $response)
    {
