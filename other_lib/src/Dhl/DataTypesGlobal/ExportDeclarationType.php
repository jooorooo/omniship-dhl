...
class ExportDeclarationType
{
     ...
     *
     * @property \Dhl\DataTypesGlobal\ExportLineItemType[] $exportLineItem
     */
     ...
     *
     * @return self
     * @param \Dhl\DataTypesGlobal\ExportLineItemType $exportLineItem
     */
    public function addToExportLineItem(\Dhl\DataTypesGlobal\ExportLineItemType $exportLineItem)
    {
     ...
     * specifics about each of the line item
     *
     * @return \Dhl\DataTypesGlobal\ExportLineItemType[]
     */
