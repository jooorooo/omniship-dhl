...
/**
 * Class representing ModifyPUResponse
 */
class ModifyPUResponse
{
    ...
    /**
     * Time to be ready by. This field is not returned for cancel pickup request
     *
    ...
    /**
     * Second time to be ready. This field is not returned for cancel pickup request
     *
    ...
    /**
     * Next possible pickup date. This field is not returned for cancel pickup request
     *
    ...
    /**
     * This field is not returned for cancel pickup request
     *
    ...
    /**
     * Time for calling in order. This field is not returned for cancel pickup request
     *
    ...
    /**
     * Second time for calling in order. This field is not returned for cancel pickup
     * request
     *
