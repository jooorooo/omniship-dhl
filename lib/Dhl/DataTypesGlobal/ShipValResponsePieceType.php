...
class ShipValResponsePieceType
{
    ...
    /**
     * @property \Dhl\DataTypesGlobal\ReferenceType[] $pieceReference
     */
     ...
     *
     * @return self
     * @param \Dhl\DataTypesGlobal\ReferenceType $pieceReference
     */
    public function addToPieceReference(\Dhl\DataTypesGlobal\ReferenceType $pieceReference)
    {
